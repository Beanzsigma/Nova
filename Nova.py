...
def main(canvas, canvas_img):
    ...
    fullresbutton1 = canvas.create_text(241, 269, text="Full Answer", font=("Necosmic Personal use", 12), fill="#319950")
    ...
    rounded_rect(canvas, 165, 257, 315, 283, r=9, color="#319950", width=3)
    def enter1(e):
    ...
    textinput.bind("<Return>", submittext)
